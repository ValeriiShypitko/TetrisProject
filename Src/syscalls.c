...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
//					printf() output routed over USART2 (PA2), which is wired to the
//					ST-LINK Virtual COM Port on the Nucleo board -- shows up in the
//					VS Code Serial Monitor / any terminal at 115200-8-N-1.
/////////////////////////////////////////////////////////////////////////////////////////////////////////
...
static void USART2_WriteChar(uint8_t ch)
{
	while (!(USART2->SR & (1U << 7))); /* wait TXE */
	USART2->DR = ch;
	while (!(USART2->SR & (1U << 6))); /* wait TC */
}
